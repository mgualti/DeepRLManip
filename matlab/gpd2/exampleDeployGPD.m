% 
% This file demos the typical process for deploying GPD to detect grasps on a
% novel point cloud.
%
...
function exampleDeployGPD
    ...
    idx = 1:l.num();
    predictionList = l.getScores('./deploy_oldversion.prototxt', './data/CAFFEfiles/lenet_iter_1000.caffemodel', 0, idx);
