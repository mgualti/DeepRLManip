...
% input: forceunorganized -> set this bit to 1 if you want to handle this
% file as an unorganized point cloud. If have seen some files that should
% be organized but are not...

function points = loadpcd(fname,forceunorganized)
...
%                 G = double(bitand(255, bitshift(rgb, 8))) /255;
                ...
                points = [points(1:3,:); R/255; G/255; B/255];
